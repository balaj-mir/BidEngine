...
import { apiService, useAuthStore } from '../../../lib/api';
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.detail || 'Registration failed. Try using demo mode on login page.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#0c0c14] via-[#09090f] to-[#070707] border-r border-[#1a1a1a] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="max-w-md my-auto space-y-6 relative z-10">
          ...
          <p className="text-gray-400 text-base leading-relaxed">
            Create an account to initialize workspaces, evaluate your organization's capability gaps, and score technical bids with calibrated algorithms.
          </p>
        </div>
        ...
        <div className="mx-auto w-full max-w-md space-y-8">
          ...
          <div className="space-y-2 text-center lg:text-left">
            ...
            <p className="text-sm text-gray-400">
              Get started with BidEngine AI today.
            </p>
          </div>
